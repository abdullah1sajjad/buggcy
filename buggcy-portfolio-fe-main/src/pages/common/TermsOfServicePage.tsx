...
import { mockTermsOfService } from "../../data/mockData";

export default function TermsOfServicePage() {
  const data = mockTermsOfService;
  ...
  return (
    <main className="min-h-screen bg-background">
      ...
      <section className="relative pt-28 pb-16 overflow-hidden">
        ...
        <div className="hero-glow glow-violet w-[500px] h-[500px] -top-40 -left-40 opacity-20" />
        <div className="hero-glow glow-cyan w-[400px] h-[400px] -bottom-40 -right-40 opacity-15" />
